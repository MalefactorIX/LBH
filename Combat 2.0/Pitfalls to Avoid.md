...
The restriction is applied to all attachments so long as the avatar continues to exceed the limit. Keep weapons around 600 to 750 RPM will make it so it is rare it hit these conditions consistently, as well as shorten the duration of any such incident due to the low overall rate of rezzing.
